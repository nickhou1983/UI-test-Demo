              ...
              <div key={trip.id} className="bg-white rounded-xl shadow-md overflow-hidden group">
                ...
                <div className="p-4 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Link
                      to={`/trips/${trip.id}`}
                      className="bg-blue-700 hover:bg-blue-800 text-white text-sm px-4 py-1.5 rounded-lg transition"
                    >
                      {t('trip.editTrip')}
                    </Link>
                    <button
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
            <h2 className="text-xl font-bold text-blue-800 mb-5">{t('trip.create')}</h2>
