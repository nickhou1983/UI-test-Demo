...
export default function HomePage() {
  ...
  const reviewSlides = reviews.map((r) => (
    <div key={r.authorKey} className="bg-white rounded-xl shadow-md p-8 text-center">
      ...
      <p className="font-bold text-blue-600">{t(r.authorKey)}</p>
  ...
  return (
    <main>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-3xl md:text-4xl font-bold text-blue-600 text-center mb-2">{t('home.popular')}</h2>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-600 text-center mb-2">{t('home.themes')}</h2>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <h2 className="text-3xl md:text-4xl font-bold text-blue-600 text-center mb-2">{t('home.reviews')}</h2>
